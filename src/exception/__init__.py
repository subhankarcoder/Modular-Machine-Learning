...
class CustomExceptionClass(Exception):
    def __init__(self, error_message: Exception, error_details: sys):
        self.error_message = CustomExceptionClass.get_detailed_error_message(error_message=error_message, error_details=error_details)
    ...
    def get_detailed_error_message(error_message: Exception, error_details: sys)->str:
        ...
        error_message = f"""
        ERROR OCCURRED IN EXECUTION OF: [{file_name}] at
    ...
    def __repr__(self):
        return CustomExceptionClass.__name__.str()